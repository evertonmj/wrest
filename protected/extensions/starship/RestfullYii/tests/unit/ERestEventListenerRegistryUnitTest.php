...
class ERestEventListenerRegistryUnitTest extends ERestTestCase
{
	...
	public function testReqGetResourceRender()
	{
		...
		$event_result_2 = $this->captureOB($this, function() {
			$this->event->emit(ERestEvent::REQ_GET_RESOURCE_RENDER, [
				null,
				'Post',
				['categories', 'author'],
	...
	public function testReqGetResourcesRender()
	{
		...
		$event_result = $this->captureOB($this, function() {
			$this->event->emit(ERestEvent::REQ_GET_RESOURCES_RENDER, [
				Post::model()->findAll(),
				'Post',
				['categories', 'author'],
				Post::model()->count()
	...
	public function testReqGetSubresourcesRender()
	{
		...
		$event_result = $this->captureOB($this, function() {
			$this->event->emit(ERestEvent::REQ_GET_SUBRESOURCES_RENDER, [
	...
	public function testReqGetSubresourceRender()
	{
		...
		$event_result = $this->captureOB($this, function() {
			$this->event->emit(ERestEvent::REQ_GET_SUBRESOURCE_RENDER, [
